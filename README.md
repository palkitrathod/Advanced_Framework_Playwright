...
- **Custom reporting & logging** — a custom Playwright reporter (`src/utils/CustomReporter.ts`) supplements the built-in HTML/list reporters, alongside Allure reporting and Winston-based logging
